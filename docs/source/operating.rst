[myfinalcybersecurityproject-389d] Operating Details
====================================
...
.. important::
   ...
   **not be valid if your [myfinalcybersecurityproject-389d] container is NOT running**.

.. tip::
   You must have your [myfinalcybersecurityproject-389d] container running before connecting to the Visualization and Airflow URLs.
...
.. note::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/leandg5/raspberrypi  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=33915  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='leandg5'  \-\-env DOCKERUSERNAME='leandg5'  \-\-env MQTTUSERNAME='leandrodg5'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   leandg5/myfinalcybersecurityproject-389d-amd64 (https://hub.docker.com/r/leandg5/myfinalcybersecurityproject-389d-amd64)
...
.. code-block::
   ...
   docker run -d -p 59631:59631 -p 60469:60469 -p 50401:50401 -p 8883:8883 \
          --env TSS=0 \
          --env SOLUTIONNAME=myfinalcybersecurityproject-389d \
          --env SOLUTIONDAG=solution_preprocessing_ai_mqtt_dag-myfinalcybersecurityproject-389d \
          --env GITUSERNAME=leandg5 \
          --env GITREPOURL=https://github.com/leandg5/raspberrypi \
          --env SOLUTIONEXTERNALPORT=59631 \
          -v /var/run/docker.sock:/var/run/docker.sock:z  \
          --env CHIP=amd64 \
          --env SOLUTIONAIRFLOWPORT=60469  \
          --env SOLUTIONVIPERVIZPORT=50401 \
          --env DOCKERUSERNAME='leandg5' \
          --env CLIENTPORT=8883  \
          --env EXTERNALPORT=33915 \
          --env KAFKACLOUDUSERNAME='' \
          --env VIPERVIZPORT=9005 \
          --env MQTTUSERNAME='leandrodg5' \
          --env AIRFLOWPORT=9000  \
          --env GITPASSWORD='<Enter Github Password>' \
          --env KAFKACLOUDPASSWORD='<Enter API secret>' \
          --env MQTTPASSWORD='<Enter mqtt password>' \
          --env READTHEDOCS='<Enter Readthedocs token>' \
          leandg5/myfinalcybersecurityproject-389d-amd64
...
[myfinalcybersecurityproject-389d] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/leandg5/raspberrypi/tree/main/tml-airflow/dags/tml-solutions/myfinalcybersecurityproject-389d
...
.. important::
   https://myfinalcybersecurityproject-389d.readthedocs.io
...
.. important::
   solution_preprocessing_ai_mqtt_dag-myfinalcybersecurityproject-389d
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=59631, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=32905, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=46775, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=40919, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=36749, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=40785, HPDEHOST=127.0.1.1, HPDEPORT=34117, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=41211

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-7027-myfinalcybersecurityproject-389d,solution_preprocessing_ai_mqtt_dag-myfinalcybersecurityproject-389d, python-preprocess-8162-myfinalcybersecurityproject-389d,solution_preprocessing_ai_mqtt_dag-myfinalcybersecurityproject-389d, python-ai-7754-myfinalcybersecurityproject-389d,solution_preprocessing_ai_mqtt_dag-myfinalcybersecurityproject-389d, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
