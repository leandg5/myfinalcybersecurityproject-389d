...
.. note::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/leandg5/raspberrypi  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=35207  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='leandg5'  \-\-env DOCKERUSERNAME='leandg5'  \-\-env MQTTUSERNAME='leandrodg5'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. code-block::
   ...
   docker run -d -p 53145:53145 -p 45491:45491 -p 50899:50899 -p 8883:8883 \
          --env TSS=0 \
          ...
          --env SOLUTIONEXTERNALPORT=53145 \
          -v /var/run/docker.sock:/var/run/docker.sock:z  \
          --env CHIP=amd64 \
          --env SOLUTIONAIRFLOWPORT=45491  \
          --env SOLUTIONVIPERVIZPORT=50899 \
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=53145, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=45051, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=39615, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=36577, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=36945, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=38221, HPDEHOST=127.0.1.1, HPDEPORT=41559, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=37937

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-8738-myfinalcybersecurityproject-389d,solution_preprocessing_ai_mqtt_dag-myfinalcybersecurityproject-389d, python-preprocess-9234-myfinalcybersecurityproject-389d,solution_preprocessing_ai_mqtt_dag-myfinalcybersecurityproject-389d, python-ai-4797-myfinalcybersecurityproject-389d,solution_preprocessing_ai_mqtt_dag-myfinalcybersecurityproject-389d, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
